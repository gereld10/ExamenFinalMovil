...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtnombrer = findViewById(R.id.txtmedicamento);
        txtdescripcionr = findViewById(R.id.txtdescripcionm);
        txtPeriocidadr = findViewById(R.id.txtfecha);
        txttiempor = findViewById(R.id.txttiempom);
        txtCantidadr = findViewById(R.id.txtcantidadm);


        btnlistaver = findViewById(R.id.btnusuarios);
